...
public class workInfo extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        DatabaseReference showDB = FirebaseDatabase.getInstance().getReference().child("Worker_Work_Info")
                ...
                updateDB.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.hasChild(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                            ...
                            DatabaseReference upRef = FirebaseDatabase.getInstance().getReference().child("Worker_Work_Info")
                                    .child(FirebaseAuth.getInstance().getCurrentUser().getUid());
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                deleteDB.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.hasChild(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                            DatabaseReference delDB = FirebaseDatabase.getInstance().getReference().child("Worker_Work_Info")
                                    .child(FirebaseAuth.getInstance().getCurrentUser().getUid());
                            delDB.removeValue();
                            clearControls();
